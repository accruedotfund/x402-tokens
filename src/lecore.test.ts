...
const base = { lecoreKey: "", lecoreTenant: "zoo", lecoreSpillTokens: 500, lecoreTopK: 4, lecoreTailChars: 2000, lecoreChunkChars: 1200, lecoreQueryChars: 400, lecoreTimeoutMs: 5000, lecoreRequired: false };
